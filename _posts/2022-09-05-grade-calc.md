...
<div class="container bg-primary">
    ...
    <form>
        ...
        <div class="form-group row" style="color: #c44282; font-size: 24px">
            Total : <span id="total" class="label label-primary">0.0</span> <br>
            Count : <span id="count" class="label label-primary">0.0</span> <br>
            Average : <span id="average" class="label label-primary">0.0</span> <br>
        </div>
        <!-- Rows -->
        <div class="form-group row">
            <h4>Input a score, and then press tab to add new number:</h4>
            <div id="scores">
